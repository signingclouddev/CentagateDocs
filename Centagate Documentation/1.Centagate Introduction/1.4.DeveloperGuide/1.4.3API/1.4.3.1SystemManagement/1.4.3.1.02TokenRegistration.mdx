...
| **METHOD**   | **PATH**                                                                      | 
| ------------ | ----------------------------------------------------------------------------- | 
| PUT          | [host]/CentagateWS/webresources/token/registerActiveToken/[adminUsername]     |
...
| tokenSn        | Required    | Token serial number.        |
| tokenType      | Required    | Token type. Type available to choose: **1 = SMS Token** or **2 = OTP Token**.|
