...
| **METHOD**   | **PATH**                                                                      | 
| ------------ | ----------------------------------------------------------------------------- | 
| PUT          | [host]/CentagateWS/webresources/user/updatebyusername/[adminUsername]         |
...
| address        | Optional    | The user’s current address. |
| zip            | Optional    | The user’s current postal code.|
| city           | Optional    | The user’s current city.    |
| state          | Optional    | The user’s current state.   |
| statusUser     | Optional    | The user’s current account status.|
| email          | Optional    | The user’s valid email address.|
| userCountryId  | Optional    | The user’s country ID.      |
| userTimeZoneId | Optional    | The user’s time zone ID.    |
| availApps      | Optional    | The user’s available apps.  |
| clientId       | Optional    | The user’s client ID.       |
| userType       | Optional    | The user’s type of user.    |
| userGroupName  | Optional    | The user’s group name.      |
| roles          | Optional    | The user’s role.            |
| cenToken       | Required    | The HMAC value is calculated using SHA-256 with secretCode as a key and plain text from adminUsername + authToken.|
