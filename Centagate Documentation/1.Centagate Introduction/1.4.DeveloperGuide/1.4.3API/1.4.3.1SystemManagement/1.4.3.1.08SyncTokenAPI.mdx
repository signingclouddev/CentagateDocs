...
| **METHOD**   | **PATH**                                                                      | 
| ------------ | ----------------------------------------------------------------------------- | 
| PUT          | {{host}}/CentagateWS/webresources/token/syncToken/{{adminUsername}}           |
...
<Table>
  ...
  <tbody>
    <tr>
      <td>username</td>
      <td>Required</td>
      <td>The OTP owner's username.</td>
    </tr>
    <tr>
      <td>data</td>
      <td>Required</td>
      <td>Base64 Encoded Of The List Of Questions And Answer. Format: Base64 (:: ,::)

*Example*: **0:Quest1:Hello World,2::Foo123**

It Will Be Sent As: **MDpRdWVzdDE6SGVsbG8gV29ybGQsMjo6Rm9vMTIz**
      </td>
    </tr>
    <tr>
      <td>cenToken</td>
...
```json
}"item": [
		{
			...
			"event": [
				{
					...
					"script": {
						"exec": [
							...
							"var otpStr1 ='first otp';\r",
                            "var otpStr2 ='second otp';\r",
							...
							"postman.setEnvironmentVariable(\"otpStr1\", otpStr1);\r",
							"postman.setEnvironmentVariable(\"otpStr1\", otpStr2);\r",
			...
			"request": {
				...
				"url": "https://{{host}}/CentagateWS/webresources/token/syncToken/{{adminUsername}}"
			},
			"response": []
		}
]
...
public static void main(String[] args) {
	...
	map.put("otpStr1", "otpStr1");
	map.put("otpStr2", "otpStr2");
	map.put("cenToken", cenToken);  

	ClientResponse response = service.path("token").path("syncToken").path(adminUsername).accept(MediaType.APPLICATION_JSON).put(ClientResponse.class, gson.toJson(map));
...
const options = {
	...
	port: 443,
	path:'/CentagateWS/webresources/token/syncToken/'+adminUsername,
	method: 'PUT',
	headers: {
...
HOST = {{host}}
ENDPOINT = "/CentagateWS/webresources/token/syncToken/" + ADMINUSERNAME
USERNAME = {{username}}
OTPSTR1 = {{otpStr1}}
OTPSTR2 = {{otpStr2}}
...
<?php
    $adminUsername = "<adminUsername>";
    $url = 'https://<domain_name>/CentagateWS/webresources/token/syncToken/'.$adminUsername;
