...
<Table>
  ...
  <tbody>
    ...
    <tr>
      <td>signature</td>
      <td>Required</td>
      <td>The PKCS#7 Attached Signature Encoded in Base64.</td>
    </tr>
    <tr>
      <td>algorithm</td>
      <td>Required</td>
      <td>The Algorithm Used During the Signing. 
...
- 3: SHA-512
    ...
    <tr>
      <td>plainText</td>
      <td>Required</td>
      <td>The Plain Text of the Signed String Encoded in Base64.</td>
    </tr>
  </tbody>
</Table>
