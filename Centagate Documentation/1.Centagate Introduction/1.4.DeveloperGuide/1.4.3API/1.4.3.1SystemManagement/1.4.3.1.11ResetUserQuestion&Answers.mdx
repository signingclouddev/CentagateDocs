---
title: 💡Reset User Question & Answers
---

# 💡Reset User Question & Answers

Call this API to reset user’s question and answers security measures.

### 🔍 URL

| **METHOD**   | **PATH**                                                                      | 
| ------------ | ----------------------------------------------------------------------------- | 
| PUT          | {{host}}/CentagateWS/webresources/security/resetQaBPI/{{adminUsername}}       |
...
```json
}"item": [
		{
			...
			"request": {
				...
				"url": "https://{{host}}/CentagateWS/webresources/security/resetQaBPI/{{adminUsername}}"
			},
			"response": []
		}
]
...
HOST = {{host}}
ENDPOINT = "/CentagateWS/webresources/security/resetQaBPI/" + ADMINUSERNAME
USERNAME = {{username}}
