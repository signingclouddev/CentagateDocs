...
| data           | Required    |Base64 encoded of the list of questions and answer. Format: **Base64 (:: ,::)**. Example: **0:Quest1:Hello World,2::Foo123** and it will be sent s **MDpRdWVzdDE6SGVsbG8gV29ybGQsMjo6Rm9vMTIz** .​|
