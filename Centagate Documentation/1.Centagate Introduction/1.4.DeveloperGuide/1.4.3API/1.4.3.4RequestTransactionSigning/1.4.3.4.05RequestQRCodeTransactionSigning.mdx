---
title: 🏾 Request QR Code Transaction Signing
---

#  🏾 Request QR Code Transaction Signing

Request a QR code for Transaction Signing.
...
```json
}"item": [
		{
			...
			"request": {
				...
				"url": "https://{{host}}/v2/CentagateWS/webresources/auth/requestQrCode"
			},
			"response": []
		}
]
...
public static void main(String[] args) {
	...
	String hmac = convertHmacSha256("secretkey","username" + "details" + "devAccId" + "authToken" + "integrationKey" + "unixTimestamp" + "supportFido" + "ipAddress" + "userAgent" + "browserFp");
...
var hmacText = username + details + devAccId + authToken + integrationKey + unixTimestamp + supportFido + ipAddress + userAgent + browserFp;
var hash, hmac;
...
<?php
    ...
    $hmac_text = $username.$details.$devAccId.$authToken.$integrationKey.$unixTimestamp.$supportFido.$ipAddress.$userAgent.$browserFp;
