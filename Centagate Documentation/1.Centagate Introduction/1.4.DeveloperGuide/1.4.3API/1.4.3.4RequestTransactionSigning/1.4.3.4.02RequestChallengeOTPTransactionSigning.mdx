---
title: 📱 Request Challenge OTP Transaction Signing
---

# 📱 Request Challenge OTP Transaction Signing

Request to send a Challenge OTP for Transaction Signing.

### 🔍 URL

| **METHOD**   | **PATH**                                                                      | 
| ------------ | ----------------------------------------------------------------------------- | 
| POST         | [host]/v2/CentagateWS/webresources/req/requestTransactionSigningChallenge     |
...
```json
		...
		{
			"name": "/auth/requestTransactionSigningChallenge",
			"event": [
				{
					"listen": "prerequest",
					"script": {
			...
			"request": {
				...
				"url": "https://{{host}}/v2/CentagateWS/webresources/auth/requestTransactionSigningChallenge"
			},
			"response": []
		}
]
...
const options = {
	...
	port: 443,
	path:'/v2/CentagateWS/webresources/req/requestTransactionSigningChallenge',
	method: 'POST',
	headers: {
...
<?php
    ...
    $url = 'https://<domain_name>/v2/CentagateWS/webresources/req/requestTransactionSigningChallenge';
    ...
    $hmac_text = $username.$details.$transactionId.$integrationKey.$unixTimestamp.$authToken.$ipAddress.$userAgent;
