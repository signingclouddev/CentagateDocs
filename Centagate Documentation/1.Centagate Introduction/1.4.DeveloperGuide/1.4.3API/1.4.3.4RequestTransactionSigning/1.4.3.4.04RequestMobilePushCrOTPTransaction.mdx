---
title: 📲 Request Mobile Push CR OTP Transaction
---

#  📲 Request Mobile Push CR OTP Transaction

Request Push CR OTP for Transaction Signing.
...
```json
}"item": [
		{
			...
			"request": {
				...
				"url": "https://{{host}}/v2/CentagateWS/webresources/auth/requestMobilePushCR"
			},
			"response": []
		}
]
